...
Для отображения списка создайте компонент `HistoryPage`, который принимает следующие атрибуты:
...
Необходимо реализовать компонет `HistoryPage`. Важно: вам нужно реализовать только список истории (аватарки и боковую панель реализовывать не нужно).

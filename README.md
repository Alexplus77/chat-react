История чата [DEMO](http://alexplus77.github.io/chat-react/)
===
...
Для отображения списка создайте компонент `MessageHistoryPage`, который принимает следующие атрибуты:
...
Необходимо реализовать компонет `MessageHistoryPage`. Важно: вам нужно реализовать только список истории (аватарки и боковую панель реализовывать не нужно).
